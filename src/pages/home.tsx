...
const cardData = [
  {
    ...
    subtitle: 'Applet #1',
    link: '/ion-t-madrijanon/click-counter',
    tags: {
      tag1: logoIonic,
      tag2: logoReact
    }
  ...
  },
  {
    ...
    icon: calculator,
    subtitle: 'Applet #2',
    link: '/ion-t-madrijanon/calculator',
    tags: {
      tag1: logoIonic,
      tag2: logoReact
    }
  },
  {
    ...
    icon: pencil,
    subtitle: 'Applet #3',
    link: '/ion-t-madrijanon/TodoList',
    tags: {
      tag1: logoIonic,
      tag2: logoReact
    }
  },
  {
    ...
    icon: chatbubble,
    subtitle: 'Applet #4',
    link: '/ion-t-madrijanon/quotegenerator',
    tags: {
      tag1: logoIonic,
      tag2: logoReact
    }
